...
import type { GetRecommendedUserResponse } from "@/libs/type/client";
...
export default async function handleRecommendation(
  req: NextApiRequest,
  res: NextApiResponse<GetRecommendedUserResponse>
) {
  ...
  const result = await server.getRecommendedUser({
