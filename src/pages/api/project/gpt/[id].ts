...
import type { MakeMilestoneGPTResponse } from '@/libs/type/client';
...
export default async function handleMakeMilestoneGPT(
  req: NextApiRequest,
  res: NextApiResponse<MakeMilestoneGPTResponse>,
) {
  ...
  const result = await server.getMakeMilestoneGPT({
