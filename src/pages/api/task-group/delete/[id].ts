...
import type { DeleteTaskGroupResponse } from '@/libs/type/client';
...
export default async function handleTaskGroupDelete(
  req: NextApiRequest,
  res: NextApiResponse<DeleteTaskGroupResponse>,
) {
  ...
  const result = await server.deleteTaskGroupInfo({
