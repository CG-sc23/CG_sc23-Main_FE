...
import type { CreateReportResponse } from '@/libs/type/client';
...
export default async function handleReportUser(
  req: NextApiRequest,
  res: NextApiResponse<CreateReportResponse>,
) {
  ...
  const result = await server.postCreateReport({
